...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    private ModArmorMaterial(String name, int durabilityMultiplier, int[] slot, int enchantmentValue, SoundEvent soundtype, float toughness, float p_i231593_9_, Supplier<Ingredient> repairIngredient) {
        this.name = name;
